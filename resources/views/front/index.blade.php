        ...
        <div id="top-banner-1" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              ...
              <!-- <img src="assets/images/logosalih.png"alt="" width="500" height="1000"> -->
            </div>
            <div class="container">
              <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  ...
                  <p>BADAN LAYANAN UMUM DAERAH INTAN HIJAU.</p>
                  <div class="main-button">
                    <a href="reservation.html">Daftar Sekarang</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"></span>
                  <h4>Pengelolaan Sampah di TPA</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"> </span>
                  <h4>Pelayanan Mobil Tangki Air Bersih</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"></span>
                  <h4>Penjualan Produk Kompos, Komposter dan Digester</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"></span>
                  <h4>Penjualan Kreatifitas 3R</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"></span>
                  <h4>Jasa Perawatan Tanaman/Kebersihan</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"> </span>
                  <h4>Jasa Sewa Cooling Air Fan</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"></span>
                  <h4>Pengangkutan Sampah Ke TPA</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
          ...
          <div class="item">
            <div class="row">
              ...
              <div class="col-lg-6 align-self-center">
                <div class="content">
                  <span class="info"></span>
                  <h4>Pengangkutan Sampah Roda Tiga</h4>
                  <div class="row">
                    <div class="col-6">
                      <i class="fa fa-check-square"></i>
                      <span class="list"> Layanan</span>
      ...
      <div class="col-lg-4">
        <div class="side-bar-map">
          <div class="row">
            <div class="col-lg-12">
              <!-- <div id="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3982.829684473066!2d114.79917301364536!3d-3.3917254498200795!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de681cf548f4db5%3A0x6e80bc1f52dbfa7a!2sMartapura%2C%20Cindai%20Alus%2C%20Kec.%20Martapura%2C%20Kabupaten%20Banjar%2C%20Kalimantan%20Selatan!5e0!3m2!1sid!2sid!4v1703068170680!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div> -->
          </div>
        </div>
      </div>
...
<div class="call-to-action">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
         <!--  <img src="assets/images/logosalih.png" alt=""> -->
          <h2>SAL-IH</h2>
          <h4>BADAN LAYANAN UMUM DAERAH INTAN HIJAU adalah Satuan Kerja Perangkat Daerah (SKPD) di lingkungan Pemerintah Kabupaten Banjar yang dibentuk untuk memberikan pelayanan kepada masyarakat berupa penyediaan barang/jasa yang dijual tanpa mengutamakan mencari keuntungan. </h4>
        </div>
        <div class="col-lg-4">
          <div class="border-button">
            <img src="{{asset('front/assets/images/manis.png')}}">
          </div>
        </div>
      </div>
    </div>
