      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="content">
            ...
            <h2><em><b>BLUD INTAN HIJAU</b></em></h2>
...
<h4>Menjadikan BLUD Intan Hijau Profesional, Mandiri dan Berwawasan Lingkungan, dengan Mencapai Pengelolaan Sampah 100% Tahun 2025</h4>
            ...
            <h4>
               ...
               Menerapkan Pengelolaan Sampah 3R di Tingkat Rumah Tangga, TPS3R dan TPA<br>
                Meningkatkan Kualitas Produk Sehingga Memiliki Daya Saing yang Tinggi<br>
                Meningkatkan Cakupan Wilayah Pelayanan Persampahan dan Air Limbah<br>
                 Meningkatkan Kesejahteraan Seluruh Karyawan BLUD Intan Hijau
            </h4>
            <p></p>
            <div class="main-button">
              <a href="reservation.html">Pesan Sekarang</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="slider-content">
          <div class="row">
            <div class="col-lg-12">
              <h2>Layanan <sup>di</sup><em>BLUD Intan Hijau</em></h2>
            </div>
            <div class="col-lg-12">
      ...
      <div class="row">
        ...
        <div class="col-lg-8 offset-lg-2">
          <div class="options">
            ...
            <!-- <div class="option" style="--optionBackground:url();">
               <div class="shadow"></div>
               <div class="label">
                  <div class="icon">
                    <i class="fas fa-expand"></i>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          ...
          <h4>Daftar Sekarang By Clicking The Button</h4>
        </div>
        <div class="col-lg-4">
